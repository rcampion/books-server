package com.zdslogic.server.plugins.books.web;
...
//import com.zdslogic.server.plugins.contacts.service.ContactService;
...
public class BookAddessStatusController {

	final static Logger LOG = LoggerFactory.getLogger(BookAddessStatusController.class);

	private static final String DEFAULT_PAGE_DISPLAYED_TO_USER = "0";

	@Autowired
	BookAddressStatusService addressStatusService;
...
//	ContactService contactService;
	...
	public ResponseEntity<Page<BookAddressStatusEntity>> findAllAddressStatuss(@RequestHeader("apikey") String apiKey, Pageable pageable, HttpServletRequest req) {
		...
		Page<BookAddressStatusEntity> page = addressStatusService.findAddressStatuses(pageable);
		return new ResponseEntity<>(page, HttpStatus.OK);
	}

	@PreAuthorize("hasRole('ROLE_ADMIN')")
	@RequestMapping(value = "/{id}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<BookAddressStatusEntity> getAddressStatus(@RequestHeader("apikey") String apiKey, @PathVariable int id, HttpServletRequest req) {
		...
		BookAddressStatusEntity apiKeyEntity = addressStatusService.getAddressStatus(id);
		return new ResponseEntity<>(apiKeyEntity, HttpStatus.OK);
	}
	
	@PreAuthorize("hasRole('ROLE_ADMIN')")
	@RequestMapping(value = "/search", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<Page<BookAddressStatusEntity>> findAllByRsql(@RequestHeader("apikey") String apiKey, Pageable pageable,
		...
		Specification<BookAddressStatusEntity> spec = rootNode.accept(new CustomRsqlVisitor<BookAddressStatusEntity>());
		Page<BookAddressStatusEntity> page = addressStatusService.searchAddressStatuses(pageable, spec);
		return new ResponseEntity<>(page, HttpStatus.OK);
	}
	...
	public ResponseEntity<String> createAddressStatus(@RequestHeader("apikey") String apiKey, @RequestBody String jsonString) {
		...
		BookAddressStatusEntity apiKeyDTO = new BookAddressStatusEntity();
		try {
			apiKeyDTO = mapper.readValue(jsonString, BookAddressStatusEntity.class);
	...
	public ResponseEntity<Object> updateAddressStatus(@RequestHeader("apikey") String apiKey, @RequestBody String jsonString) {
		...
		BookAddressStatusEntity apiKeyEntity = new BookAddressStatusEntity();
		try {
			apiKeyEntity = mapper.readValue(jsonString, BookAddressStatusEntity.class);
		} catch (JsonParseException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} catch (JsonMappingException e) {
